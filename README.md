...
[![Release Workflow](https://github.com/Jurg0/project_01/actions/workflows/release.yml/badge.svg)](https://github.com/Jurg0/project_01/actions/workflows/release.yml)
[![Coverage Status](https://img.shields.io/badge/Coverage-View%20Reports-blue)](https://github.com/Jurg0/project_01/actions/workflows/ci.yml)
...
### Continuous Integration (CI) for Tests and Coverage

Unit tests and JaCoCo coverage reports are automatically generated by the GitHub Actions `ci.yml` workflow on every push and pull request to the `main` branch.

You can view the workflow runs [here](https://github.com/Jurg0/project_01/actions/workflows/ci.yml).
After a successful run, the JaCoCo HTML and XML reports are uploaded as artifacts, which you can download from the workflow run summary page.```
